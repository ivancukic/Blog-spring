          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Blog Post Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="post-save" modelAttribute="post" role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Text</label>
                    <form:input type="text" class="form-control" placeholder="Enter text" path="text"/>
                  </div>
                  <div class="form-group">
                    <label>Image</label>
                  ...
                  <div class="form-group">
							<form:hidden path="authorImage" value="${authorPicture }"/>
                  </div>
                  <div class="form-group">
                    <label>Date</label>
                    <form:input type="text" class="form-control" placeholder="Enter date" path="date"/>
                  </div>
                  <div class="form-group">
                    <label>Number Of Comments</label>
                    <form:input type="text" class="form-control" placeholder="Enter number of comments" path="commentCounter"/>
                  </div>
                   <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <form:select class="form-control" path="tags" itemLabel="name" multiple="true" itemValue="id" items="${tagList }"/>
                  </div>
                  
                   <div class="custom-control custom-checkbox">
                          <form:checkbox class="custom-control-input" id="customCheckbox1" path="isImportant"/>
                          <label for="customCheckbox1" class="custom-control-label">Importan Blog</label>
                  </div>
