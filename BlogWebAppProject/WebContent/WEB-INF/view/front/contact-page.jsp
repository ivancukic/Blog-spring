  ...
  <body>
              ...
              <div class="col-md-8">
                <form:form action="search" method="GET">
                  <div class="form-group">
                    <input type="text" name="theSearchPost" id="search" placeholder="What are you looking for?">
    ...
    <div class="container">
      <div class="row">
        ...
        <main class="col-lg-8"> 
          <div class="container">
            <form:form action="message-save" modelAttribute="message" role="form" method="post" class="commenting-form">
              <div class="row">
                ...
                <div class="form-group col-md-12">
                  <form:textarea placeholder="Type your message" class="form-control" rows="20" path="text"></form:textarea>
                </div>
                <div class="form-group col-md-12">
