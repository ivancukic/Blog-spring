    	...
    	<c:forEach var="slider" items="${sliders }">
	      <section style="background: url(${slider.image}); background-size: cover; background-position: center center" class="hero">
	        <div class="container">
	          <div class="row">
	            <div class="col-lg-7">
	              <h1>${slider.slideTitle }</h1>
	              <a href="${slider.linkUrl }" class="hero-link">${slider.linkTitle }</a>
	            </div>
	          </div>
	        </div>
	      </section>
			            ...
			            <div class="text-inner d-flex align-items-center">
			              <div class="content">
			                <header class="post-header">
			                  <div class="category"><a href="blog-category.html">${posts[i].category.name }</a></div><a href="blog-post.html">
			                    <h2 class="h4">${posts[i].title }</h2></a>
			                </header>
			                <p>${posts[i].text }</p>
			                <footer class="post-footer d-flex align-items-center"><a href="author-page?author=${post.author }" class="author d-flex align-items-center flex-wrap">
			                    <div class="avatar"><img src="dist/${posts[i].authorImage  }" alt="..." class="img-fluid"></div>
			                    <div class="title"><span>${posts[i].author }</span></div></a>
			                  <div class="date"><i class="icon-clock"></i> ${posts[i].date }</div>
			                  <div class="comments"><i class="icon-comment"></i>${posts[i].commentCounter }</div>
			                </footer>
			              </div>
			            </div>
			          </div>
			          <div class="image col-lg-5"><img src="${posts[i].image }" alt="..."></div>
			        </div>
			      </c:if>
			      <c:if test="${i%2==0 }">
			        <!-- Post-->
        	...
        	<c:forEach var="i" begin="0" end="${postList.size()-1 }" > 
	          <div class="row">
	            <div class="post col-md-4">
	              <div class="post-thumbnail"><a href="blog-post.html"><img src="${postList[i].image }" alt="..." class="img-fluid"></a></div>
	              <div class="post-details">
	                <div class="post-meta d-flex justify-content-between">
	                  <div class="date">${postList[i].date }</div>
	                  <div class="category"><a href="blog-category.html">${postList[i].category.name }</a></div>
	                </div><a href="blog-post.html">
	                  <h3 class="h4">${postList[i].title }</h3></a>
	                <p class="text-muted">${postList[i].text }</p>
	              </div>
	            </div>
