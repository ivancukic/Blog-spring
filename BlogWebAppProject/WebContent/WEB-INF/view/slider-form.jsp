          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Blog Slider Form</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form:form action="slider-save" modelAttribute="slider" role="form">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <form:input type="text" class="form-control" placeholder="Enter slider title" path="slideTitle"/>
                  </div>
                  <div class="form-group">
                    <label>Link Title</label>
                    <form:input type="text" class="form-control" placeholder="Enter link title" path="linkTitle"/>
                  </div>
                  <div class="form-group">
                    <label>Link URL</label>
                    <form:input type="text" class="form-control" placeholder="Enter link url" path="linkUrl"/>
                  </div>
                  <div class="custom-control custom-checkbox">
                          <form:checkbox class="custom-control-input" id="customCheckbox1" path="isOnIndexPage"/>
                          <label for="customCheckbox1" class="custom-control-label">Show On Index Page</label>
                  </div>
                </div>
                <!-- /.card-body -->
